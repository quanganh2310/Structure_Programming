...
class DetailUnit extends Component {
  ...
  getDeliveries = async () => {
    return await axios.get('https://online-selling-website.herokuapp.com/delivery_units/'+this.props.match.params.unitId+'/deliveries');
  }
...
//   getDeliveries = async () => {
//     return await axios.get('https://online-selling-website.herokuapp.com/delivery_units/'+this.query+'/deliveries');
//   }
